        ...
        <div className="fixed bottom-24 right-6 z-50 flex h-[500px] max-h-[calc(100vh-120px)] w-80 flex-col overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-primary/10 sm:w-96">
          ...
          <div className="flex items-center justify-between bg-primary p-4 text-white">
            <div className="flex items-center space-x-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-accent text-sm font-bold">
                E
              </div>
                  ...
                  <div className="mt-2 flex flex-col items-start space-y-2 pl-2">
                    {msg.options.map((opt, i) => (
                      <button
                        ...
                        className="rounded-full border border-accent/30 bg-white px-4 py-1.5 text-sm text-accent transition-colors hover:bg-accent hover:text-white"
                      >
                        {opt.label}
                      </button>
                    ))}
          ...
          <div className="border-t border-gray-100 bg-white p-4">
            <form onSubmit={handleSubmit} className="flex relative">
              <input
                ...
                className="w-full rounded-full border border-gray-300 bg-gray-50 py-2.5 pl-4 pr-12 text-[15px] text-primary focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
                autoComplete="off"
              />
              <button
                type="submit"
