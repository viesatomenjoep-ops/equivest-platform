...
const translations = {
  en: {
    toggle: 'Chat Support',
    welcome: 'Welcome to Placeholder Brand. How can we assist you today?',
  ...
  nl: {
    ...
    welcome: 'Welkom bij Placeholder Brand. Hoe kunnen we u vandaag helpen?',
  ...
  de: {
    toggle: 'Chat-Support',
    welcome: 'Willkommen bei Placeholder Brand. Wie können wir Ihnen heute helfen?',
  ...
  es: {
    ...
    welcome: 'Bienvenido a Placeholder Brand. ¿Cómo podemos ayudarle hoy?',
...
export default function Chatbot({ lang = 'en' }: ChatbotProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (inputMode === 'email') {
      ...
      // Trigger user's mail client to send the invitation request to Placeholder Brandbv@gmail.com
      const subject = encodeURIComponent("Investment Meeting Request - Placeholder Brand");
      const body = encodeURIComponent(`Hello,\n\nI would like to schedule an investment meeting.\nMy contact email is: ${val}\n\nPlease reach out to me.\n\nThank you.`);
      window.location.href = `mailto:Placeholder Brandbv@gmail.com?subject=${subject}&body=${body}`;
        ...
        <div className="fixed bottom-24 right-6 z-50 flex h-[500px] max-h-[calc(100vh-120px)] w-80 flex-col overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-primary/10 sm:w-96">
          ...
          <div className="flex items-center justify-between bg-primary p-4 text-white">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold tracking-wide">Placeholder Brand Assistant</span>
            </div>
